...
```
{
  ...
  "criteria": {
    ...
    "network": [],
    "_comment_elevation_range": "Specify minimum and maximum terrain elevation or leave empty for any elevation",
    "elevation_range": [],
    "_comment_latitude_range": "Specify minimum and maximum latitude or leave empty for any latitude",    
    "latitude_range": [],
    "_comment_longitude_range": "Specify minimum and maximum longitude or leave empty for any longitude",        
    "longitude_range": [],
